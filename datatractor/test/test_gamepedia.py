...
blocks_url = find_revision_url("Java_Edition_data_values/Block_IDs", next_date)
print("Block IDs for version %s: %s" % (version, blocks_url))

items_url = find_revision_url("Java_Edition_data_values/Item_IDs", next_date)
print("Item IDs for version %s: %s" % (version, items_url))

entities_url = find_revision_url("Java_Edition_data_values/Entity_IDs", next_date)
print("Entity IDs for version %s: %s" % (version, entities_url))

stone_url = find_revision_url("Furnace", next_date)
