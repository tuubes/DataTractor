...
blocks_url = get_revision_url("Java_Edition_data_values/Block_IDs", release_date, next_date)
print("Block IDs for version %s : %s" % (version, blocks_url))

items_url = get_revision_url("Java_Edition_data_values/Item_IDs", release_date, next_date)
print("Item IDs for version %s : %s" % (version, items_url))

entities_url = get_revision_url("Java_Edition_data_values/Entity_IDs", release_date, next_date)
